...
- `void *recreate(void *ptr, size_t size)` Resizes an existing allocation, preserving data up to the minimum of the old and new sizes.
    - ptr == NULL → acts like create 
    - size == 0 → frees the block
